...
RUN wget -O /THIRD-PARTY-LICENSES-20200824.tar.gz https://corretto.aws/downloads/resources/licenses/alpine/THIRD-PARTY-LICENSES-20200824.tar.gz && \
    ...
    apk add --no-cache amazon-corretto-18=$version-r0 binutils && \
    ...
    apk del binutils amazon-corretto-18 && \
    mkdir -p /usr/lib/jvm/ && \
    mv /opt/corretto-slim /usr/lib/jvm/java-18-amazon-corretto && \
    ln -sfn /usr/lib/jvm/java-18-amazon-corretto /usr/lib/jvm/default-jvm
